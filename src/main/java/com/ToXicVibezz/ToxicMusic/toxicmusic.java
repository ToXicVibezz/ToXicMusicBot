 ...
 */
package com.ToXicVibezz.ToxicMusic;

import com.jagrosh.jdautilities.command.CommandClient;
import com.jagrosh.jdautilities.command.CommandClientBuilder;
import com.jagrosh.jdautilities.commons.waiter.EventWaiter;
import com.jagrosh.jdautilities.examples.command.*;
import com.ToXicVibezz.ToxicMusic.commands.admin.*;
import com.ToXicVibezz.ToxicMusic.commands.dj.*;
import com.ToXicVibezz.ToxicMusic.commands.general.*;
import com.ToXicVibezz.ToxicMusic.commands.music.*;
import com.ToXicVibezz.ToxicMusic.commands.owner.*;
import com.ToXicVibezz.ToxicMusic.entities.Prompt;
import com.ToXicVibezz.ToxicMusic.gui.GUI;
import com.ToXicVibezz.ToxicMusic.settings.SettingsManager;
import com.ToXicVibezz.ToxicMusic.utils.OtherUtil;
 ...
 */
public class toxicmusic 
{
    public final static Logger LOG = LoggerFactory.getLogger(toxicmusic.class);
    ...
    private static CommandClient createCommandClient(BotConfig config, SettingsManager settings, Bot bot)
    {
        ...
        AboutCommand aboutCommand = new AboutCommand(Color.BLUE.brighter(),
                                "a music bot that is [the shit!](https://github.com/ToXicVibezz/ToxicMusic/) (v" + OtherUtil.getCurrentVersion() + ")",
